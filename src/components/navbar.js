  ...
  return `
    <header class="sticky top-0 z-40 w-full glass-panel" style="border-radius: 0; border-top: none; border-left: none; border-right: none; background: rgba(7, 14, 23, 0.92);">
      <div class="container-custom py-3 flex items-center justify-between gap-4">
        ...
        <nav class="hide-mobile flex items-center gap-1.5 p-1 rounded-full glass-panel-subtle" style="border: 1.5px solid rgba(220, 173, 84, 0.4); box-shadow: 0 0 15px rgba(220, 173, 84, 0.2);">
        ...
        <div class="flex items-center gap-2">
          ...
          <!-- Staff Profile Indicator (Visible in Staff / Supervisor / Manager Mode) -->
